...
$config = array(
    ...
    'site.desc' => 'Nesta quarta edição alem da comunidade de São Paulo, também
                    ...
                    produtividade, com o Daniel Jesus.
                    <br /><br />
                    Com participação especial do Leonardo Alberto Souza, vamos desvendar
                    os segredos do DOM, e te soltar da prisão dos principais frameworks
                    JavaScript.
                    <br /><br />
                    Caio Gondin vai nos ensinar como debugar uma aplicação de forma
                    simples e prática com breakpoins, analisar a anatomia, JS Living Editing
                    e Debug direto do sublime Text.
                    ',
    'site.robots' => 'INDEX, NOFOLLOW',
    'site.keywords' => 'site, puc consolação, javascript, html5, perfomance, VanillaJS, chrome, webkit, joão vagner brito de medeiros, jean nascimento, suissa',
);
?>
